...
import type { IrCell, IrRow, IrSheet, IrWorkbook, Side } from './types.js';
  ...
  return (
    <td
      ...
      className={cn(
        ...
        'max-w-[340px] min-w-[70px] overflow-hidden border border-paper-200 px-2 py-0.5 align-bottom text-ellipsis whitespace-nowrap',
        ALIGNMENT[kind(cell)],
      )}
      style={{
