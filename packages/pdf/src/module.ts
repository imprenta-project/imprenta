...
export interface Exports {
  ...
  imprenta_render(irPtr: number, irLen: number): number;
  imprenta_measure_rows(
    setupPtr: number,
    setupLen: number,
    headPtr: number,
    headLen: number,
  ...
  imprenta_measured_release(): number;
  imprenta_plan(setupPtr: number, setupLen: number, heightsPtr: number, heightsLen: number): number;
  imprenta_merge_reset(): number;
  imprenta_merge_push(ptr: number, len: number): number;
  imprenta_merge_finish(): number;
  imprenta_stream_open(ptr: number, len: number): number;
  imprenta_stream_nodes(ptr: number, len: number): number;
  imprenta_stream_open_table(ptr: number, len: number): number;
  imprenta_stream_rows(ptr: number, len: number): number;
  ...
  imprenta_diagnostics_len(): number;
